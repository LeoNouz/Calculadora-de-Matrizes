...
class Matriz {
    public:
        ...
        void somar_real(const float numero) const;
        void subtrair_real(const float numero) const;
        void multiplicar_real(const float numero) const;
        void dividir_real(const float numero) const;
    private:
